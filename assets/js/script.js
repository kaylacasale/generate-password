var enterLengthEl = document.querySelector('.enterLength');
...
var numberLength = Number(numberInputEl.value);
var passwordLength;
//var lengthOutput = lengthFunction(numberLength);

// check input value is equal to numberLength variable
...
// if numberLength is not a value, display error message
function getLength() {
    if (!numberLength) {
        errorEl.innerHTML = "";
